...
const VideoFilmInput = ({episode, video, changeEpisode}) => {
    ...
    const PreviewPicture = () => {
        return (
            <div className='group absolute w-[198px] h-[198px] top-0 left-0 z-[2] rounded-[5px] overflow-hidden   '>
                <video className='w-full h-full object-cover' alt="preview video" autoPlay muted  controls >
    ...
    const SelectPicture = () => {
        return (
            <div className='relative'>
                ...
                <input type="file" accept="video/mp4,video/x-m4v,video/*"  className='input-default hidden' name="video" id="video"
