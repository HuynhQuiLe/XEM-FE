...
const Comment = ({session_id}) => {
  ...
  return (
    <div className='mt-[100px]' id="comment">
      ...
      />
      <CommentForm setLoadAgain={setLoadAgain} responseUser={responseUser} reponseCommentID={reponseCommentID} setResponseUser={setResponseUser} setResponseCommentID={setResponseCommentID} loadAgain={loadAgain}/>
