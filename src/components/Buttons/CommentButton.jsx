...
import SmallLoadingCircle from '../Icons/Loading/SmallLoadingCircle';

const CommentButton = ({responseUser, disabled, comment_text, setLoadAgain, setResponseCommentID, reponseCommentID, loadAgain, setDisabled, setComment_text, session_id}) => {
