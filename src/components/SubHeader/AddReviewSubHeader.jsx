...
const AddReviewSubHeader = () => {
  ...
  return (
    ...
    >
        ...
        {!isShow && <div className='ml-[6px] bg-primary text-black rounded-[8px] h-[60px] flex items-center px-[6px]  cursor-pointer hover:text-white transition-default' onClick={()=> navigate('/preview')}>
